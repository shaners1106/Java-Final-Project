...
public class EndSavingsFrame extends JFrame{
	 ...
	 */
	EndSavingsFrame(int pin,CSVFileReader file,String date){
		this.date = date;
		this.pin = pin;
		this.file = file;
		...
		custInfo.setText(file.getCustomers().get(index).displaySavingsInfo());
